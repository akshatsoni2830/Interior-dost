    ...
    <div className="w-full space-y-6">
      ...
      <div>
        <label
          ...
          className="block text-sm sm:text-base font-semibold text-gray-800 mb-2 sm:mb-3"
        >
        ...
        <input
          ...
          className="w-full px-4 sm:px-5 py-3 sm:py-4 text-sm sm:text-base border-2 border-gray-300 rounded-xl focus:ring-4 focus:ring-blue-300 focus:border-blue-500 disabled:bg-gray-100 disabled:cursor-not-allowed transition-all duration-300 shadow-sm hover:shadow-md"
      ...
      <div>
        <p className="text-sm sm:text-base font-semibold text-gray-800 mb-3 sm:mb-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {vibePresets.map(({ preset, label, description }) => (
            <button
              ...
              disabled={disabled}
              className="p-4 sm:p-5 border-2 border-gray-300 rounded-xl hover:border-blue-500 hover:bg-blue-50 hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 text-left group focus:outline-none focus:ring-4 focus:ring-blue-300 transform hover:scale-105"
              aria-label={`Select ${label} preset`}
              data-preset={preset}
            >
              <div className="font-bold text-base sm:text-lg text-gray-900 mb-1 sm:mb-2 group-hover:text-blue-600 transition-colors">
                {label}
              </div>
              <div className="text-xs sm:text-sm text-gray-600 group-hover:text-gray-800 transition-colors leading-relaxed">
                {description}
              </div>
            </button>
          ))}
